...
\begin{figure}[b]
    ...
    \begin{tikzpicture}
        \pie[text=legend, 
            ...
            {1/Initialisation, 5/Bounds, 51/Type and Lifetime, 9/Arithmetic, 1/Threading, 1/Sequencing, 1/Assumptions, 5/Control Flow, 3/Replacement Functions, 3/Coroutines}
    \end{tikzpicture}
...
Such a control mechanism for runtime checks (or for other tools in our toolbox such as language subsetting) needs to be designed carefully and take into account the overall strategy (Figure~\ref{magicslide}). In particular, we need to make it clear which feature is responsible for providing the user-facing configuration mechanism for which tool, and avoid ending up in a situation where the same functionality is provided simultaneously by different features in incompatible ways.
