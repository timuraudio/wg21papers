...
\cite{P0593R6} addressed this use case by providing a library facility \tcode{std::start_lifetime_as}, in addition to the proposed core language changes, to tell the compiler explicitly that an object should be created at the given memory location:
