...
We believe that Options 1 --- 3 are all worth considering and the tradeoffs of each option are sufficiently clear. We therefore propose all three options to determine which option has more consensus in SG21. 
...
Thanks to John Lakos for his review of the paper.
