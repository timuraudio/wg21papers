...
Three of the seven tools discussed above need to be \emph{configurable} by the user in order to be usable in practice: erroneous behaviour, runtime checks, and language subsetting.
