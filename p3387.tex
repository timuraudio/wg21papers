...
Given the existence of this workaround, we might as well provide the ability to place \tcode{pre} and \tcode{post} on \tcode{f} directly.
...
%JMB: The thing that is missing in that section, in think, is clearly stating that the allocation function and the copy initialization all happen as part of the replacement body.  If we do that, then we get all the other orderings that we want.
%
