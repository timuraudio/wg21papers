...
It therefore seems most logical to define Profiles as a higher-level feature building on top of these three basic tools (see Figure~\ref{fig_magicslide}). Essentially, a particular profile can be completely defined as a named configuration preset for these features. 
