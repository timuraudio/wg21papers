...
\{temp.inst.inf.recursion\}. This case should be specified as ill-formed instead of UB. % TODO: once there is a core issue or paper for this, cite it here.
...
\begin{itemize}
\item \textbf{R4}, 2025-08-13: Updated the paper to align with \cite{P3745R0}; incorporated feedback from the WG21 meeting in Sofia; added references to relevant Core issues published since last revision; improved paper structure.
