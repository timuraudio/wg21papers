...
\item contract properties such as \tcode{new}, indicating that the contract assertion was newly added to a legacy codebase;
...
\added{The optional \emph{attribute-specifier-seq} appertains to the introduced contract assertion.}
\end{adjustwidth}
