...
\item \textbf{R2}, 2022-07-09: Added \tcode{const} and \tcode{const volatile} overloads, \tcode{noexcept}, and alignment precondition; moved wording for \emph{reachable through} from [ptr.launder] to [basic.compound]; minor wording fixes following CWG review and LWG small group review.
\end{itemize}
