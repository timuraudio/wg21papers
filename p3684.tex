...
% TODO:
% - discarded values (comma operator)
% - lvaue-to-rvalue conversion
% - all the other conversions as well
\end{addedblock}
...
the result of the evaluation is \removed{the value so produced but is not erroneous}\added{that erroneous value}:
\begin{itemize}
