...
Finally, several of the available tools overlap in scope with \emph{Profiles}, another proposed feature currently in development. A discussion of how Profiles might fit into our proposed strategy can be found in Section~\ref{profiles}.
