...
Originally, we constructed our list independently from another effort to enumerate core language UB led by Shafik Yaghmour (see \cite{P1705R1}, \cite{P3075R0}). The current list in \hyperref[appendix]{Appendix~A} represents a merger of the lists produced by both efforts, further increasing confidence that we in fact exhaustively covered all core language UB explicitly specified in the current C++ working paper. Separately from this paper, \cite{P3596R1} proposes to add a UB and IFNDR annex to the C++ Standard; the proposed enumeration of core language UB in that proposed annex, and the stable identifiers used therein, are in sync with \hyperref[appendix]{Appendix~A} of this paper. 
