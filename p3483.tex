...
\begin{addedblock}
\begin{codeblock}
% TD: This code example is not good because it relies on
% each postcondition being evaluated exactly once with a 
% checked semantic, which is not something P2900 guarantees.
% We need a different example to illustrate the point here!
int f()
  post(r : ++const_cast<int&>(r) == 1)
