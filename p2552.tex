...
If we adopt the Third Ignorability Rule, the behaviour of \tcode{__has_cpp_attribute} on Clang, ICC, and MSVC for \tcode{carries_dependency} will constitute a compiler bug, while the behaviour on GCC for \mbox{\tcode{carries_dependency}} and on MSVC for \tcode{no_unique_address} will be considered conformant.
...
Wording for the Third Ignorability Rule, fixing the ambiguity of \tcode{__has_cpp_attribute}, has not yet been adopted into the C++ Standard. Our proposed changes relative to the Working Draft \cite{N4944} are to modify [cpp.cond] paragraphs 5 and 6 as follows:
