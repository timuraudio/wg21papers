...
% I don't agree that this is true. If Solution 5 "limits use of move operations to those types where the source is known to be unmodified or which are totally move-unaware", then I don't see how that it could possibly expose moved-from values, and if it doesn't do that, it doesn't violate this design goal. We keep going in circles on this one; I still think that this isn't productive or important for the paper.
