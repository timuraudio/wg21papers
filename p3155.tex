...
operator should be marked as conditionally \tcode{noexcept} the underlying exception
...
\begin{addedblock}
\begin{itemize}
\item Functions that cannot throw should be marked as \tcode{noexcept} if they do not specify undefined behavior due to a \emph{Precondition}; otherwise, they should be specified with \emph{Throws: nothing}.
\end{itemize}
\end{addedblock}
