...
\begin{document}
\title{Contracts for C++: \tcode{const} parameters in\\ postconditions of overridden functions}
\author{
...
Note that choosing Option~1 would leave the door open to adopting Option~2 or Option~3 at some point in the future, while Option~2 could only be evolved towards Option~3 but not Option~1, and Option~3 could not be evolved towards either of the other options.
